      ...
      <div className="container py-5" id="footer">
        <div className="row">
          <div className="col-md-3">
            <h2>MR.Photographer</h2>
            <p>
              <span>Mr.Photographer </span> We're Tilia, a team of photographers
              & videographers. Sed ut perspiciatis unde omnis iste natus error
              sit voluptatem accusantium doloremque laudantium. Est sale
              definitiones id. Ut quo quem harum munere, eu labore voluptatum
              mei.
            </p>
          ...
          <div className="col-md-3 footer-subscription ml-0 ">
            <h1 className="mt-4 text-light">NEWSLETTER</h1>
